...
const THEMES = {
  ...
  "SOLARIZED LIGHT": {bg: "#fdf6e3", bg_panel: "rgba(238, 232, 213, 0.88)", bg_menu: "#e8e2d0", accent: "#268bd2", accent_menu: "#2aa198", text_main: "#073642", text_sec: "#586e75", text_dim: "#93a1a1", border: "rgba(38, 139, 210, 0.18)", border_solid: "#c4b898"},
  ...
  "CATPPUCCIN LATTE": {bg: "#eff1f5", bg_panel: "rgba(188, 192, 204, 0.60)", bg_menu: "#dce0e8", accent: "#8839ef", accent_menu: "#209fb5", text_main: "#4c4f69", text_sec: "#6c6f85", text_dim: "#9ca0b0", border: "rgba(136, 57, 239, 0.15)", border_solid: "#acb0be"},
